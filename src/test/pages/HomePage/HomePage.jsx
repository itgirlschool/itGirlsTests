            ...
            <main className='home-container'>
                <div className='wr-home_container'>
                    ...
                    <div className='instuctions'>
                        <p className='first'>В данном тесте у нас c тобой <b>{week.questions.length}</b> вопросов.
                        Читай каждый вопрос и ответ очень внимательно, так как у тебя должно быть
                            из <b>{week.questions.length}</b> вопросов <b>{week.questions.length - 1}</b> правильных, что бы пройти тест и заработать кристалл. </p>
